...
{
	include('modules/secretbox/pon_mode/pon_coupon.php');
}
else								// Honor scouting
{
	include('modules/secretbox/pon_mode/pon_loveca.php');
}

// Use placeholder unit_own_id if necessary
if($add_unit_list[0]['unit_owning_user_id'] == 0)
	$add_unit_list[0]['unit_owning_user_id'] = token_use_pseudo_unit_own_id($TOKEN);
