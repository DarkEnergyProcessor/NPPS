...
INSERT INTO `birthday_login_bonus` VALUES("12-09", CONCAT("September 9 is Kotori Minami's birthday!", CHAR(10), "To celebrate the occasion, we are giving away 5 Love Gems", CHAR(10), "as a Login Bonus today."), "assets/image/ui/login_bonus_extra/birthday_5_1.png", 3001, NULL, 5);	-- Kotori
INSERT INTO `birthday_login_bonus` VALUES("21-10", CONCAT("October 10 is Eli Ayase's birthday!", CHAR(10), "To celebrate the occasion, we are giving away 5 Love Gems", CHAR(10), "as a Login Bonus today."), "assets/image/ui/login_bonus_extra/birthday_6_1.png", 3001, NULL, 5);		-- Eli
